# 1.项目介绍
- 系统角色：管理员、普通用户
- 功能模块：用户管理、房源分类管理、房源信息管理、租房信息管理、租房、支付、咨询等
...
- 配置tomcat，启动项目，其中，我将deployment下的application contex配置为 /ssm7feg6
- http://localhost:8080/ssm7feg6/admin/dist/index.html   管理员账号密码：abo/abo， 其他自行查表
